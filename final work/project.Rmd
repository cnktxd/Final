...
library(tidyverse)
library(readr)
nuclear_explosions1 <- read_csv("C:/Users/canso/Desktop/Final/final work/data/nuclear_explosions1.csv")
comparison1 <- read_csv("/Users/canso/Desktop/Final/final work/data/comparison1.csv")
```
...
ggplot(data=comparison1, aes(x=yield_upper, group=country, fill=country)) +
    geom_density(adjust=170, alpha=1, ) +
    theme_ipsum() +
    facet_wrap(~country) +
...
ggplot(data=comparison1, aes(x=yield_upper,mean(x=226.34)  group=country, fill=country)) +
    geom_density(adjust=180, alpha=0.6) +
    ggthemes::theme_stata() +
    theme(legend.position = "none")
```
