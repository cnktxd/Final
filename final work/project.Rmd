...
I conducted a Welch T-Test to analyse the effectiveness of the nuclear tests of the US and France. Tests of France had a mean of 103.8889 while the tests of the US had a mean of 226.3377. This can be a sign that the tests of the US were more efficient than France's nuclear tests.
...
t.test(yield_upper ~ country, data = comparison1,var.equal = FALSE)
```
...
ggplot(comparison1, mapping=aes(x = yield_upper, y = country, fill = stat(x))) +
  ...
  scale_x_continuous(expand = expand_scale(mult = c(0, 0.25))) +
